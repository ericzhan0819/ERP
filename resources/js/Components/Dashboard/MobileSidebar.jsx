    ...
    return (
        ...
        >
            <button
                type="button"
                onClick={onClose}
                className="absolute inset-0 bg-app/70 backdrop-blur-sm transition-opacity duration-200"
                aria-label="Close sidebar"
            />

            <aside
                className={`relative flex h-full w-[290px] max-w-[86vw] flex-col overflow-hidden border-r border-default bg-surface shadow-2xl transition-transform duration-200 ease-out ${
            ...
            >
                ...
                <div className="flex h-[88px] shrink-0 items-center justify-between border-b border-default px-5">
                    ...
                    <button
                        type="button"
                        onClick={onClose}
                        className="grid h-10 w-10 place-items-center rounded-xl border border-default text-secondary transition hover:bg-hover active:scale-[0.98]"
                        aria-label="Close sidebar"
                    >
                ...
                <nav className="flex-1 overflow-y-auto px-4 py-6">
                    <div className="mb-4 px-3 text-[10px] font-semibold uppercase leading-5 tracking-[0.28em] text-muted">Menu</div>
