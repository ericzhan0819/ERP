...
class RolePermissionSeeder extends Seeder
{
     ...
     */
    private const ACTION_WHITELIST = ['view', 'create', 'update', 'delete', 'export', 'approve', 'post', 'void', 'mark-sold', 'confirm', 'complete', 'review', 'convert', 'manage'];
    ...
    public function run(): void
    {
        ...
        $modules = [
            ...
            'accounting-event-mappings' => [
                ...
                'parent_id' => null,
                'parent_key' => null,
                'route_name' => 'employee-system.accounting.event-mappings.index',
                'permission_prefix' => 'module.accounting.event-mappings',
                'base_permission' => 'module.accounting.event-mappings.view',
                'icon_key' => 'Receipt',
                'icon' => 'Receipt',
                'sort_order' => 42,
                'is_enabled' => true,
                'is_active' => true,
                'active_patterns' => ['employee-system.accounting.event-mappings.*'],
            ],
            'audit' => [
                'label' => '稽核紀錄',
                'section' => 'administration',
        ...
        $permissionDefinitions = [
            ...
            'module.accounting.events.void' => ['label' => '作廢會計事件', 'group' => '會計事件'],
            'module.accounting.events.convert' => ['label' => '轉傳票會計事件', 'group' => '會計事件'],
            'module.accounting.event-mappings.view' => ['label' => '查看會計事件映射', 'group' => '會計事件映射'],
            'module.accounting.event-mappings.create' => ['label' => '建立會計事件映射', 'group' => '會計事件映射'],
            'module.accounting.event-mappings.update' => ['label' => '更新會計事件映射', 'group' => '會計事件映射'],
        ...
        $roleTemplates = [
            'admin' => [
                ...
                'module.accounting.event-mappings.create',
