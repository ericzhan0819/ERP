    ...
    return (
        <DashboardLayout title="測試模塊">
            ...
            <section className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 backdrop-blur-xl">
                <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-cyan-300/70">RBAC Checkpoint</p>
                <h1 className="mt-3 text-2xl font-semibold tracking-tight text-zinc-50">測試模塊</h1>
